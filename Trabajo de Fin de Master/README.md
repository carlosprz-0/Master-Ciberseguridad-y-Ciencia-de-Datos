...
- Integrar Ascon-AEAD128 y AES-CCM128 para establcer una comparación entre ambas.
- Evaluar la recuperación correcta de la clave secreta.
- Comparar el rendimiento en ML-KEM-512, ML-KEM-768 y ML-KEM-1024.
- Medir tiempos de ejecución por iteración, metricas y consumo de los recursos utilizados.
