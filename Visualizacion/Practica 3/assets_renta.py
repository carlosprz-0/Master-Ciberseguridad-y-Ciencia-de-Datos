...
# CHECK 1 (carga): raw_renta no vacío
...
# CHECK 2 (transformación): no hay valores nulos en OBS_VALUE tras filtrar
@asset_check(asset=raw_renta)
...
# CHECK 3 (integración): tras el merge, la mayoría tiene ISLA
...
# CHECK 4 (visualización): el PNG se genera
